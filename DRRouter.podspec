...
Pod::Spec.new do |s|
  s.name             = 'DRRouter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DRRouter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Dean_F/DRRouter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dean_F' => 'stone.feng1990@gmail.com' }
  s.source           = { :git => 'https://github.com/Dean_F/DRRouter.git', :tag => s.version.to_s }
